...
var style_SOLANEAllChannelsFinalPh2_5 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 12.800000000000004 + size, points: 6,
        ...
        image: new ol.style.RegularShape({radius: 5.236363636363637 + size, points: 6,
